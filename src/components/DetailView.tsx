      ...
      <>
        <div>
          <Flex className="space-x-0.5" justifyContent="start" alignItems="center">
            <Title> Top Price Changes </Title>
            <Icon
              icon={InformationCircleIcon}
              variant="simple"
              tooltip="Shows top inventory price changes"
            />
          </Flex>
        </div>
        ...
        <Table className="mt-6">
          <TableHead>
            <TableRow>
              ...
              <TableHeaderCell className="text-right">Previous (RM)</TableHeaderCell>
              <TableHeaderCell className="text-right">Current (RM)</TableHeaderCell>
              <TableHeaderCell className="text-right">Difference (RM)</TableHeaderCell>
              <TableHeaderCell className="text-right">Dfference (%)</TableHeaderCell>
